...
MySQL - 10.4.17-MariaDB : Database - sgr5
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`sgr5` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `sgr5`;

/*Table structure for table `mst_d_kabupaten` */

DROP TABLE IF EXISTS `mst_d_kabupaten`;

CREATE TABLE `mst_d_kabupaten` (
...
/*Data for the table `mst_d_kabupaten` */

insert  into `mst_d_kabupaten`(`id_kab`,`id_prov`,`nama`,`id_jenis`) values 
...
/*Table structure for table `mst_d_kecamatan` */

DROP TABLE IF EXISTS `mst_d_kecamatan`;

CREATE TABLE `mst_d_kecamatan` (
...
/*Data for the table `mst_d_kecamatan` */

insert  into `mst_d_kecamatan`(`id_kec`,`id_kab`,`nama`) values 
...
/*Table structure for table `mst_d_provinsi` */

DROP TABLE IF EXISTS `mst_d_provinsi`;

CREATE TABLE `mst_d_provinsi` (
  `id_prov` char(2) NOT NULL,
  `nama` tinytext NOT NULL,
  PRIMARY KEY (`id_prov`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `mst_d_provinsi` */

insert  into `mst_d_provinsi`(`id_prov`,`nama`) values 
('11','Aceh'),
('12','Sumatera Utara'),
('13','Sumatera Barat'),
('14','Riau'),
