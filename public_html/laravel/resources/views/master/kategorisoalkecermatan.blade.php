...
<h1 class="m-0">Kategori Soal Kecermatan</h1>
@endsection

@section('contentheadermenu')
<ol class="breadcrumb float-sm-right">
    <!-- <li class="breadcrumb-item">Bank Soal Kecermatan</li> -->
    <li class="breadcrumb-item active">Bank Soal Kecermatan</li>
</ol>
@endsection
                    ...
                    <td width="1%" class="_align_center">
                      <div class="btn-group">
                        <span data-toggle="tooltip" data-placement="left" title="Bank Soal">
                          <a href="{{url('mastersoalkecermatan')}}/{{$key->id}}" class="btn btn-sm btn-outline-info"><i class="fas fa-th-list"></i></a>
                        </span>
                        ...
                        @else
                          <span data-toggle="tooltip" data-placement="left" title="Harap hapus soal ini pada paket soal kecermatan terlebih dahulu">
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "{{ url('/hapuskategorisoalkecermatan') }}/"+idform;
        $.ajaxSetup({
            headers: {
    ...
    $(document).on('click', '.btn-submit-data', function (e) {
        ...
        $('#formData_'+idform).validate({
          ...
          submitHandler: function () {
            ...
            var url = "{{ url('/updatekategorisoalkecermatan') }}/"+idform;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
    ...
    $('#_formData').validate({
          ...
          submitHandler: function () {
            ...
            var url = "{{ url('storekategorisoalkecermatan') }}";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
