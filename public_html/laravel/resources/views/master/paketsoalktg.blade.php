...
<h1 class="m-0">Kategori Paket Soal Pilihan Ganda</h1>
@endsection

@section('contentheadermenu')
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a class="_kembali" href="{{url('paketsoal')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a></li>
</ol>
@endsection
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                <div class="row">
                    <div class="col-sm-2">Paket</div>
                    <div class="col-sm-10">: {{$datamst->judul}}</div>
                </div>
                <div class="row">
                    <div class="col-sm-2">Waktu</div>
                    <div class="col-sm-10">: {{$datamst->waktu}} Menit</div>
                </div>
                <div class="row">
                    <div class="col-sm-2">Total Soal</div>
                    <div class="col-sm-10">: {{$datamst->total_soal}} Butir</div>
                </div>
                <!-- <div class="row">
                    <div class="col-sm-2">KKM</div>
                    <div class="col-sm-10">: {{$datamst->kkm}}</div>
                </div> -->
              </div>
              <!-- <div class="card-header">
          ...
          <form method="post" id="formData_{{$key->id}}" class="form-horizontal">
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                ...
                <!-- <div class="form-group"> -->
                    <!-- <label for="kkm_{{$key->id}}">KKM (0-100)<span class="bintang">*</span></label> -->
                    <input type="hidden" class="form-control int" id="kkm_{{$key->id}}" name="kkm[]" placeholder="KKM" value="{{$key->kkm}}">
                <!-- </div> -->
                <!-- /.form-group -->
              <!-- </div> -->
            </div>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form method="post" id="formHapus_{{$key->id}}" class="form-horizontal">
            @csrf
            <div class="modal-body">
                <h6> Apakah anda ingin menghapus data paket soal kategori {{$key->fk_kategori_soal}}?</h6>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
      ...
      <div class="modal-content">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              ...
              <!-- <div class="form-group"> -->
                  <!-- <label for="kkm_add">KKM (0-100)<span class="bintang">*</span></label> -->
                  <input type="hidden" class="form-control int" id="kkm_add" name="kkm_add" placeholder="KKM" value="0">
              <!-- </div>  -->
              <!-- <div class="card-body"> -->
              <!-- /.form-group -->
            <!-- </div> -->
