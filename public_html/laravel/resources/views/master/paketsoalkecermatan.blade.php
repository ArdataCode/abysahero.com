                  ...
                  <tr>
                    ...
                    <td width="1%" class="_align_center">
                      <div class="btn-group">
                        ...
                        @php
                          $cekdata = App\Models\MemberDtl::where('fk_paket_soal_mst',$key->id)->where('jenis',2)->get();
                        @endphp
                        @if(count($cekdata)<=0)
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control int" id="kkm_{{$key->id}}" name="kkm[]" placeholder="KKM" value="{{$key->kkm}}">
                </div>
                <div class="form-group">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control int" id="kkm_add" name="kkm_add" placeholder="KKM" value="0">
              </div>
              <div class="form-group">
