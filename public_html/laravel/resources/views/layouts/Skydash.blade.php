  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="{{url('/')}}"><img src="{{ asset($template->logo_besar) }}" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{url('/')}}"><img src="{{ asset($template->logo_kecil) }}" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a href="{{url('transaksi')}}" class="dropdown-item preview-item">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="{{ asset('image/global/unknown_user.png') }}" alt="profile"/>
            </a>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item {{$menu=='home' ? 'active' : '' }}">
            <a class="nav-link _nav-link" href="#" _link="{{url('home')}}">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Dashboard</span>
            </a>
          </li>
          <li class="nav-item {{$menu=='kerjakansoal' ? 'active' : '' }}">
            <a class="nav-link _nav-link" href="#" _link="{{url('kerjakansoal')}}">
              <i class="icon-paper menu-icon"></i>
              <span class="menu-title">Kerjakan Soal</span>
            </a>
          </li>
          <li class="nav-item {{$menu=='hasilujian' ? 'active' : '' }}">
            <a class="nav-link _nav-link" href="#" _link="{{url('hasilujian')}}">
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title">Hasil Ujian</span>
            </a>
          </li>
          <li class="nav-item {{$menu=='transaksi' ? 'active' : '' }}">
            <a class="nav-link _nav-link" href="#" _link="{{url('transaksi')}}">
      ...
      @show
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2022 from Ardata Media. All rights reserved.</span>
